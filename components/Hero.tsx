  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button aria-disabled href="https://github.com/cloudable-dev/netgoat">Coming Soon.</Button>
        <Button
          href="#features"
          variant="outline"
        >
          <span className="">See the features</span>
        </Button>
      </div>
      {
        /* */
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Trusted by these 0 companies so far (ouch)
        </p>
        <ul
          role="list"
